...
!(function (t, e) {
	...
	const i = e(t),
		...
		h = (t) =>
			c(t) ? (t.jquery ? t[0] : t) : "string" == typeof t && t.length > 0 ? document.querySelector(r(t)) : null,
		d = (t) => {
	...
	class Nt extends R {
		...
		_addEventListeners() {
			this._config.keyboard && F.on(this._element, vt, (t) => this._keydown(t)),
				...
				this._config.touch && lt.isSupported() && this._addTouchEventListeners();
		}
	...
	class be extends R {
		constructor(t, e) {
			super(t, e),
				...
				(this._menu =
					V.next(this._element, ce)[0] || V.prev(this._element, ce)[0] || V.findOne(ce, this._parent)),
		...
		_selectMenuItem({ key: t, target: e }) {
			const i = V.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter((t) =>
				d(t),
			);
		...
		static dataApiKeydownHandler(t) {
			...
			const n = this.matches(ae)
					? this
					: V.prev(this, ae)[0] || V.next(this, ae)[0] || V.findOne(ae, t.delegateTarget.parentNode),
	...
	F.on(document, _i, '[data-bs-toggle="offcanvas"]', function (t) {
		...
		F.on(window, ui, () => {
			for (const t of V.find("[aria-modal][class*=show][class*=offcanvas-]"))
				"fixed" !== getComputedStyle(t).position && pi.getOrCreateInstance(t).hide();
		}),
		Q(pi),
		v(pi);
	const bi = {
		...
		show() {
			...
			if (
				(this._element.ownerDocument.documentElement.contains(this.tip) ||
					(s.append(i), F.trigger(this._element, this.constructor.eventName("inserted"))),
		...
		_setListeners() {
			...
			for (const e of t)
				if ("click" === e)
					...
					const t =
							e === Di ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"),
						i =
							e === Di
					...
					F.on(this._element, t, this._config.selector, (t) => {
						...
						F.on(this._element, i, this._config.selector, (t) => {
							const e = this._initializeOnDelegatedTarget(t);
							(e._activeTrigger["focusout" === t.type ? Ni : Di] = e._element.contains(t.relatedTarget)),
								e._leave();
						});
				}
	...
	const Ri = ".bs.scrollspy",
		...
		Ji = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: !1, target: null, threshold: [0.1, 0.5, 1] },
		Zi = {
			offset: "(number|null)",
			rootMargin: "string",
	...
	class ts extends R {
		...
		_activateParents(t) {
			...
			else for (const e of V.parents(t, ".nav, .list-group")) for (const t of V.prev(e, Gi)) t.classList.add(Xi);
		}
		_clearActiveClass(t) {
